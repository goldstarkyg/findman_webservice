...
<?php $__env->startSection('title'); ?>
    <?php echo e(_t(config('Convert.tags')[0], [], $_SESSION['lang'])); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <section class="content-header">
        <h1><?php echo e(_t(config('Convert.tags')[0], [], $_SESSION['lang'])); ?></h1>
        <ol class="breadcrumb">
            <li>
            ...
            <li class="active"><?php echo e(_t(config('Convert.tags')[0], [], $_SESSION['lang'])); ?></li>
        </ol>
    </section>
    <!-- Main content -->
                        ...
                        <h3 class="panel-title">
                                    <span style="font-size: 110%">
                                     <i class="livicon" data-name="tags" data-size="15" data-c="#fff" data-hc="#fff"
                                        data-loop="true"></i>
                                        <?php echo e(_t(config('Convert.tags')[0], [], $_SESSION['lang'])); ?></span>
                        </h3>
                    </div>
                        ...
                        <table class="table table-striped table-bordered table-hover dataTable no-footer sample_editable"
                            ...
                            <tr role="row">
                                ...
                                <th class="sorting_asc" tabindex="0" aria-controls="occasiontable" rowspan="1"
                                    colspan="1" aria-label="
                                                Name
                                            : activate to sort column ascending" style="width: 100px;"><?php echo e(_t(config('Convert.tag_name')[0], [], $_SESSION['lang'])); ?>
                                ...
                                <th class="sorting" tabindex="0" aria-controls="occasiontable" rowspan="1"
                                    colspan="1" aria-label="
                                                Created Date
                                            : activate to sort column ascending" style="width: 150px;"><?php echo e(_t(config('Convert.create_date')[0], [], $_SESSION['lang'])); ?>

                                </th>
                                <th class="sorting" tabindex="0" aria-controls="occasiontable" rowspan="1"
                                    colspan="1" aria-label="
                                                status
                                            : activate to sort column ascending" style="width: 50px;"><?php echo e(_t(config('Convert.status')[0], [], $_SESSION['lang'])); ?>

                                </th>
                                <th class="sorting" tabindex="0" aria-controls="occasiontable" rowspan="1"
                                    colspan="1" aria-label="
                                                Edit
                                            : activate to sort column ascending" style="width: 50px;"><?php echo e(_t(config('Convert.edit')[0], [], $_SESSION['lang'])); ?>

                                </th>
                                <th class="sorting" tabindex="0" aria-controls="occasiontable" rowspan="1"
                                    colspan="1" aria-label="
                                                Delete
                                            : activate to sort column ascending" style="width: 50px;"><?php echo e(_t(config('Convert.delete')[0], [], $_SESSION['lang'])); ?>
    ...
    <div class="modal fade" id="addModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog" role="document">
            <form role="form" action="<?php echo e(route('admin.tag.add')); ?>" id="AddCategoryForm" method="POST" enctype="multipart/form-data">
                <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>"/>
                <div class="modal-content" style="width: 80%">
                    <div class="modal-header" style="font-size: 150%">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                        <h4 class="modal-title" id="myModalLabel"><?php echo e(_t(config('Convert.add_tag')[0], [], $_SESSION['lang'])); ?> </h4>
                    </div>
                    <div class="modal-body" style="font-size: 120%">
                        <table style="width:50%" class="table form-body" border="0">
                            <tr style="border:0">
                                <th style="border:0"><?php echo e(_t('Category name', [], $_SESSION['lang'])); ?>:</th>
                                <td style="border:0">
                                    <input type="text" name="name" class="form-control" id="name"  value="" placeholder="<?php echo e(_t('Category name', [], $_SESSION['lang'])); ?>">
                                </td>
                            </tr>
                        </table>
                    </div>
    ...
    <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog" role="document">
            <form role="form" action="<?php echo e(route('admin.tag.edit')); ?>" id="EditCategoryForm" method="POST" enctype="multipart/form-data">
                <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>"/>
    ...
    <div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog" role="document">
            <div class="modal-content" style="width: 80%">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" class="form-control" data-dismiss="modal" onclick="deleteTag()"><?php echo e(_t(config('Convert.delete')[0], [], $_SESSION['lang'])); ?></button>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content" style="width: 80%">
                ...
                <div class="modal-body" id="messagecontent">
                    <?php echo e(_t(config('Convert.tag_inpute_message')[0], [], $_SESSION['lang'])); ?>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content" style="width: 80%">
                ...
                <div class="modal-body" id="statecontent">
                    <?php echo e(_t(config('Convert.tag_active_message')[0], [], $_SESSION['lang'])); ?>

                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" class="form-control" data-dismiss="modal" onclick="inactive_tag()"><?php echo e(_t(config('Convert.ok')[0], [], $_SESSION['lang'])); ?></button>
                    <button type="button" class="btn btn-default" class="form-control" data-dismiss="modal"><?php echo e(_t(config('Convert.cancel')[0], [], $_SESSION['lang'])); ?></button>
                </div>
            </div>
        </div>
    ...
    <div class="modal fade" id="inactiveModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog" role="document">
            <div class="modal-content" style="width: 80%">
                ...
                <div class="modal-body" id="statecontent">
                    <?php echo e(_t(config('Convert.tag_inactive_message')[0], [], $_SESSION['lang'])); ?>

                </div>

                <div class="modal-footer">
                    <button type="button" class="btn btn-default" class="form-control" data-dismiss="modal" onclick="active_tag()"><?php echo e(_t(config('Convert.ok')[0], [], $_SESSION['lang'])); ?></button>
                    <button type="button" class="btn btn-default" class="form-control" data-dismiss="modal"><?php echo e(_t(config('Convert.cancel')[0], [], $_SESSION['lang'])); ?></button>
                </div>
            </div>
        </div>
    ...
    <script>
        ...
        $(function () {
            ...
            table = $('#tagtable').DataTable({
                processing: true,
                serverSide: true,
                ajax: '<?php echo route("admin.tag.data"); ?>',
                columns: [
                    {data: 'id', name: 'id'},
                    {data: 'name', name: 'name'},
            ...
            $('#tagtable_length').append('<button type="button" style="margin-left: 20px; border:1px solid #ccc; background-color: #6c7def; color: white" class="form-control button-sm" data-toggle="modal" data-target="#addModal"><?php echo e(_t(config('Convert.add')[0], [], $_SESSION['lang'])); ?></button >');
            ...
            function editRow(table, nRow) {
                ...
                jqTds[4].innerHTML = '<a class="edit" href=""><?php echo e(_t(config('Convert.save')[0], [], $_SESSION['lang'])); ?></a>';
                jqTds[5].innerHTML = '<a class="cancel" href=""><?php echo e(_t(config('Convert.cancel')[0], [], $_SESSION['lang'])); ?></a>';
            }
    ...
    <script>
        ...
        function addTag () {
            ...
            if (name == "") {
                ...
                $('#messagecontent').html('<?php echo e(_t('Please input tag name.', [], $_SESSION['lang'])); ?>');
