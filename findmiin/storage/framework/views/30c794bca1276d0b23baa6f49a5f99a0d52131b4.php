...
<?php $__env->startSection('content'); ?>
    ...
    <div class="panel-body" style="width:90%;margin-left:5%">
                ...
                <form role="form" action="<?php echo e(url('/admin/cardfinds/'.$client->id.'/update')); ?>" id="CardfindUpdateForm" method="POST" enctype="multipart/form-data">
                    ...
                    <input type="hidden" name="id" id="card_id" value="<?php echo e($client->id); ?>"/>
                    ...
                    <div class="form-group has-success row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div>
                                <input type="text" class="form-control" id="email" name="email" value="<?php echo e($email_str); ?>" placeholder="email">
                            </div>
                        </div>
                    </div>
                    <div class="form-group has-success row">
                            ...
                            <?php /*<div class="row" style="margin-bottom: 10px">*/ ?>
                                ...
                                <?php /*<div class="col-sm-10">*/ ?>
                                    <?php /*<input value="Jobs" type="checkbox" class="form-control"*/ ?>
                                           <?php /*<?php echo e(in_array('Jobs', $section_list)? 'checked':''); ?>*/ ?>
                                           <?php /*onclick="setPrivilege('0','Jobs')" style="width:16px;height:16px;margin-top:0px;"/>*/ ?>
                                <?php /*</div>*/ ?>
                            <?php /*</div>*/ ?>
                            ...
                            <div class="row" style="margin-bottom: 10px">
                                ...
                                <div class="col-sm-10">
                                    <input id="section_<?php echo e($num); ?>" value="<?php echo e($section->name); ?>" type="checkbox" class="form-control"
                                           <?php echo e(in_array($section->name, $section_list)? 'checked':''); ?>

                                           onclick="setPrivilege('<?php echo e($num); ?>','<?php echo e($section->name); ?>')" style="width:16px;height:16px;margin-top:0px;"/>
                                </div>
                            </div>
                            <?php } ?>
                        </div>
                        ...
                        <div class="col-md-12" style="display: -webkit-box">
                            <table class="table table-striped table-bordered table-hover dataTable no-footer sample_editable"
                                ...
                                <tr role="row">
                                    ...
                                    <?php /*<th width="10%" class="sorting" tabindex="0" aria-controls="occasiontable" rowspan="1"*/ ?>
                                        <?php /*colspan="1"><?php echo e(_t('Edit', [], $_SESSION['lang'])); ?>*/ ?>
                                    <?php /*</th>*/ ?>
                                ...
                                <tr id="tr_sel_<?php echo e($comment->id); ?>">
                                    ...
                                    <?php /*<td><span class="btn btn-default" data-toggle="modal" onclick="editBtn('<?php echo e($comment->id); ?>','<?php echo e($comment->visitor_name); ?>','<?php echo e($comment->rating); ?>','<?php echo e($comment->content); ?>');" data-target="#editModal" style="padding:2px 8px;">Edit</span></td>*/ ?>
                                    <td><span class="btn btn-default" data-toggle="modal" onclick="deleteBtn('<?php echo e($comment->id); ?>','del');" data-target="#deleteModal" style="padding:2px 8px;">Delete</span></td>
