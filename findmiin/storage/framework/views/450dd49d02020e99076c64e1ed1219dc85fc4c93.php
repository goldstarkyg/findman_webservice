...
<?php $__env->startSection('title'); ?>
    <?php echo e(_t('Sections', [], $_SESSION['lang'])); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <section class="content-header">
        <h1><?php echo e(_t('Sections', [], $_SESSION['lang'])); ?></h1>
        <ol class="breadcrumb">
            <li>
            ...
            <li class="active"><?php echo e(_t('Sections', [], $_SESSION['lang'])); ?></li>
        </ol>
    </section>
    <!-- Main content -->
                    ...
                    <div class="panel-heading">
                        <h3 class="panel-title">
                                    <span style="font-size: 110%">
                                     <i class="livicon" data-name="tasks" data-size="15" data-c="#fff" data-hc="#fff"
                                        data-loop="true"></i>
                                        <?php echo e(_t('Sections', [], $_SESSION['lang'])); ?></span>
                        </h3>
                    </div>
                            ...
                            <tr role="row">
                                <th class="sorting_asc" tabindex="0" aria-controls="occasiontable" rowspan="1"
                                    colspan="1" aria-label="
                                                ID
                                            : activate to sort column ascending" style="width: 30px;"><?php echo e(_t('ID', [], $_SESSION['lang'])); ?>

                                </th>
                                <th class="sorting_asc" tabindex="0" aria-controls="occasiontable" rowspan="1"
                                    colspan="1" aria-label="
                                                Name
                                            : activate to sort column ascending" style="width: 100px;"><?php echo e(_t('Section Name', [], $_SESSION['lang'])); ?>

                                </th>
                                <th class="sorting" tabindex="0" aria-controls="occasiontable" rowspan="1"
                                    colspan="1" aria-label="
                                                Photo
                                            : activate to sort column ascending" style="width: 50px;"><?php echo e(_t('Photo', [], $_SESSION['lang'])); ?>

                                </th>
                                <th class="sorting" tabindex="0" aria-controls="occasiontable" rowspan="1"
                                    colspan="1" aria-label="
                                                Created Date
                                            : activate to sort column ascending" style="width: 150px;"><?php echo e(_t('Created Date', [], $_SESSION['lang'])); ?>

                                </th>
                                <th class="sorting" tabindex="0" aria-controls="occasiontable" rowspan="1"
                                    colspan="1" aria-label="
                                                status
                                            : activate to sort column ascending" style="width: 50px;"><?php echo e(_t('Status', [], $_SESSION['lang'])); ?>

                                </th>
                                <th class="sorting" tabindex="0" aria-controls="occasiontable" rowspan="1"
                                    colspan="1" aria-label="
                                                Edit
                                            : activate to sort column ascending" style="width: 50px;"><?php echo e(_t('Edit', [], $_SESSION['lang'])); ?>

                                </th>
                                <th class="sorting" tabindex="0" aria-controls="occasiontable" rowspan="1"
                                    colspan="1" aria-label="
                                                Delete
                                            : activate to sort column ascending" style="width: 50px;"><?php echo e(_t('Delete', [], $_SESSION['lang'])); ?>
    ...
    <div class="modal fade" id="addModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog" role="document">
            <form role="form" action="<?php echo e(route('admin.category.add')); ?>" id="AddCategoryForm" method="POST" enctype="multipart/form-data">
                <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>"/>
                <div class="modal-content" style="width: 80%">
                    <div class="modal-header" style="font-size: 150%">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                        <h4 class="modal-title" id="myModalLabel"><?php echo e(_t('Add Section', [], $_SESSION['lang'])); ?> </h4>
                    </div>
                    <div class="modal-body" style="font-size: 120%">
                        <table style="width:50%" class="table form-body" border="0">
                            <tr style="border:0">
                                <th style="border:0"><?php echo e(_t('Section Name', [], $_SESSION['lang'])); ?>:</th>
                                <td style="border:0">
                                    <input type="text" name="name" class="form-control" id="name"  value="" placeholder="<?php echo e(_t('Section name', [], $_SESSION['lang'])); ?>">
                                </td>
                            </tr>
                        </table>
                    </div>
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-default" class="form-control" data-dismiss="modal" onclick="addCategory()"><?php echo e(_t('Add', [], $_SESSION['lang'])); ?></button>
                        <button type="button" class="btn btn-default" class="form-control" data-dismiss="modal"><?php echo e(_t('Cancel', [], $_SESSION['lang'])); ?></button>
                    </div>
                </div>
            </form>
        </div>
    ...
    <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog" role="document">
            <form role="form" action="<?php echo e(route('admin.category.edit')); ?>" id="EditCategoryForm" method="POST" enctype="multipart/form-data">
                <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>"/>
                    ...
                    <div class="modal-body" style="font-size: 120%">
                        <table style="width:50%" class="table form-body" border="0">
                            <tr style="border:0">
                                <th style="border:0"><?php echo e(_t('Section Name', [], $_SESSION['lang'])); ?>:</th>
                                <td style="border:0">
                                    <input type="text" name="name" class="form-control" id="edit_name"  value="" placeholder="<?php echo e(_t('Section name', [], $_SESSION['lang'])); ?>">
                                </td>
                            </tr>
                        </table>
                    </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content" style="width: 80%">
                ...
                <div class="modal-body">
                    <?php echo e(_t(config('Convert.category_delete_message')[0], [], $_SESSION['lang'])); ?>

                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" class="form-control" data-dismiss="modal" onclick="deleteCategory()"><?php echo e(_t('Delete', [], $_SESSION['lang'])); ?></button>
                    <button type="button" class="btn btn-default" class="form-control" data-dismiss="modal"><?php echo e(_t('Cancel', [], $_SESSION['lang'])); ?></button>
                </div>
            </div>
        </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content" style="width: 80%">
                ...
                <div class="modal-body" id="statecontent">
                    <?php echo e(_t(config('Convert.category_active_message')[0], [], $_SESSION['lang'])); ?>

                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" class="form-control" data-dismiss="modal" onclick="inactive_category()"><?php echo e(_t('OK', [], $_SESSION['lang'])); ?></button>
                    <button type="button" class="btn btn-default" class="form-control" data-dismiss="modal"><?php echo e(_t('Cancel', [], $_SESSION['lang'])); ?></button>
                </div>
            </div>
        </div>
    ...
    <div class="modal fade" id="inactiveModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog" role="document">
            <div class="modal-content" style="width: 80%">
                ...
                <div class="modal-body" id="statecontent">
                    <?php echo e(_t(config('Convert.category_inactive_message')[0], [], $_SESSION['lang'])); ?>

                </div>

                <div class="modal-footer">
                    <button type="button" class="btn btn-default" class="form-control" data-dismiss="modal" onclick="active_category()"><?php echo e(_t('OK', [], $_SESSION['lang'])); ?></button>
                    <button type="button" class="btn btn-default" class="form-control" data-dismiss="modal"><?php echo e(_t('Cancel', [], $_SESSION['lang'])); ?></button>
                </div>
            </div>
        </div>
...
<?php $__env->startSection('footer_scripts'); ?>
    ...
    <?php /*<script type="text/javascript" src="<?php echo e(asset('assets/js/pages/table-editable.js')); ?>" ></script>*/ ?>
    ...
    <script>
        ...
        $(function () {
            ...
            $('#citytable_length').append('<button type="button" style="margin-left: 20px; border:1px solid #ccc; background-color: #6c7def; color: white" class="form-control button-sm" data-toggle="modal" data-target="#addModal"><?php echo e(_t(config('Convert.add')[0], [], $_SESSION['lang'])); ?></button >');
            ...
            function editRow(table, nRow) {
                ...
                jqTds[4].innerHTML = '<a class="edit" href=""><?php echo e(_t('Save', [], $_SESSION['lang'])); ?></a>';
                jqTds[5].innerHTML = '<a class="cancel" href=""><?php echo e(_t('Cancel', [], $_SESSION['lang'])); ?></a>';
            }
    ...
    <script>
        ...
        function addCategory1 () {
            ...
            var name = $("#name").val();
            if (name == "") {
                $('#messagecontent').html('<?php echo e(_t("Please input category name.", [], $_SESSION['lang'])); ?>');
                $('#messageModal').modal('show');
                return;
            }
            var photo = $("#photo").val();
            if (photo == "") {
                $('#messagecontent').html('<?php echo e(_t("Please select image.", [], $_SESSION['lang'])); ?>');
                $('#messageModal').modal('show');
                return;
            }
            ...
            //??? formData.append('photo', $('#photo').fi);
        ...
        function active_category(){
            ...
            $.ajax({
                type: "get",
                url: '/admin/category/' + id + '/activecategory',
                success: function (result) {
        ...
        function inactive_category(){
            ...
            $.ajax({
                type: "get",
                url: '/admin/category/' + id + '/inactivecategory',
                success: function (result) {
