<ul id="menu" class="page-sidebar-menu">
    ...
    <li <?php echo (Request::is('admin/section') || Request::is('admin/section/*') || Request::is('admin/category') ? 'class="active"' : ''); ?>>
        ...
        <ul class="sub-menu">
            ...
            <?php } ?>
            <?php /*<li <?php echo ( isset($_SESSION['sectionType'])?($_SESSION['sectionType'] == 'jobs' ? 'class="active" id="active"' : ''):''); ?>*/ ?>
                <?php /*style="display: <?php echo e(in_array('jobs', $privilege_w)? 'block':(in_array('jobs', $privilege_r)? 'block':'none')); ?>">*/ ?>
                <?php /*<a href="<?php echo e(URL::to('admin/section/?sectionType=jobs')); ?>">*/ ?>
                    <?php /*<i class="fa fa-angle-double-right"></i>*/ ?>
                    <?php /*<?php echo e(_t('Jobs', [], $_SESSION['lang'])); ?>*/ ?>
                <?php /*</a>*/ ?>
            <?php /*</li>*/ ?>
