...
<header class="header">
    <a href="<?php echo e(route('dashboard')); ?>" class="logo" style="color:white;font-size:20px;text-align: left;">
        <img src="<?php echo e(url('/img/logo.png')); ?>" alt="logo" style="width:20px;margin-top:-5px;">&nbsp;&nbsp;&nbsp;<span><?php echo e(_t('FINDMIIN' , [], $_SESSION['lang'])); ?></span>
    </a>
...
<script type="text/javascript">
    ...
    function sqlImport(){
        ...
        if(filetype != "sql"){
            $('#messagecontent').html('File type incorrectly. &nbsp;&nbsp;&nbsp;Please select correctly SQL file.');
            $('#messageModal').modal('show');
            return;
        }
