...
<?php $__env->startSection('title'); ?>
    <?php echo e(_t($sectionType, [], $_SESSION['lang'])); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <section class="content-header">
        <h1><?php echo e(_t($sectionType, [], $_SESSION['lang'])); ?></h1>
        <ol class="breadcrumb">
            <li>
            ...
            <li class="active"><?php echo e(_t($sectionType, [], $_SESSION['lang'])); ?></li>
        </ol>
    </section>
    <!-- Main content -->
                        ...
                        <h3 class="panel-title">
                                    <span style="font-size: 110%">
                                     <i class="livicon" data-name="notebook" data-size="15" data-c="#fff" data-hc="#fff"
                                        data-loop="true"></i>
                                        <?php echo e(_t($sectionType, [], $_SESSION['lang'])); ?></span>
                        </h3>
                    </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content" style="width: 80%">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" class="form-control" data-dismiss="modal" onclick="deleteData()"><?php echo e(_t(config('Convert.delete')[0], [], $_SESSION['lang'])); ?></button>
    ...
    <div class="modal fade" id="activeModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog" role="document">
            <div class="modal-content" style="width: 80%">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" class="form-control" data-dismiss="modal" onclick="inactive_data()"><?php echo e(_t(config('Convert.ok')[0], [], $_SESSION['lang'])); ?></button>
                    <button type="button" class="btn btn-default" class="form-control" data-dismiss="modal"><?php echo e(_t(config('Convert.cancel')[0], [], $_SESSION['lang'])); ?></button>
                </div>
            </div>
        </div>
    ...
    <div class="modal fade" id="inactiveModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog" role="document">
            <div class="modal-content" style="width: 80%">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" class="form-control" data-dismiss="modal" onclick="active_data()"><?php echo e(_t(config('Convert.ok')[0], [], $_SESSION['lang'])); ?></button>
                    <button type="button" class="btn btn-default" class="form-control" data-dismiss="modal"><?php echo e(_t(config('Convert.cancel')[0], [], $_SESSION['lang'])); ?></button>
                </div>
            </div>
        </div>
...
<?php $__env->startSection('footer_scripts'); ?>
    ...
    <script>
        ...
        $(function () {
            ...
            table = $('#datatable').DataTable({
                ...
                serverSide: true,
                autoWidth: false,
                ajax: '<?php echo route("admin.section.data"); ?>',
                columns: [
                    { data: 'id', name: 'id' },
    ...
    <script>
        ...
        function active_data(){
            ...
            $.ajax({
                type: "get",
                url: '/admin/section/' + id + '/activedata',
                success: function (result) {
        ...
        function inactive_data(){
            ...
            $.ajax({
                type: "get",
                url: '/admin/section/' + id + '/inactivedata',
                success: function (result) {
