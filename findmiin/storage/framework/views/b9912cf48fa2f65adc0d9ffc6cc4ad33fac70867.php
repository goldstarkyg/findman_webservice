...
<?php $__env->startSection('content'); ?>
    ...
    <div class="panel-body" style="width:90%;margin-left:5%">
        ...
        <form role="form" action="<?php echo e(route('admin.cardfinds.adddata')); ?>" id="CardfindAddForm" method="POST" enctype="multipart/form-data">
            <input type="hidden" id="_token" name="_token" value="<?php echo e(csrf_token()); ?>"/>
            <?php /*<input type="hidden" name="type" value="<?php echo e($type); ?>"/>*/ ?>
            ...
            <div class="form-group has-success row">
                <div class="col-md-6">
                    ...
                    <div>
                        <input type="text" class="form-control pull-right" id="contract_start_date" name="contract_start_date" size="20" placeholder="contract start date" value="<?php echo e($today); ?>">
                    </div>
                </div>
                <div class="col-md-6">
                    <label class="control-label" style="font-size: 120%" for="name">Contract End Date</label>
                    <div>
                        <input type="text" class="form-control pull-right" id="contract_end_date" name="contract_end_date" size="20" placeholder="contract end date" value="<?php echo e($today); ?>">
                    </div>
                </div>
            </div>
            <div class="form-group has-success row">
            ...
            <div class="form-group has-success row">
                <div class="col-md-12">
                    ...
                    <div class="row" style="margin-bottom: 10px">
                        ...
                        <div class="col-sm-10">
                            <input id="section_<?php echo e($num); ?>" value="<?php echo e($section->name); ?>" type="checkbox" class="form-control" onclick="setPrivilege('<?php echo e($num); ?>','<?php echo e($section->name); ?>')" style="width:16px;height:16px;margin-top:0px;"/>
                        </div>
                    </div>
                    <?php } ?>
                </div>
            ...
            <div class="col-md-12 mar-10" style="padding-top:30px;">
                <?php /*<input type="submit" value="Add Client" style="font-size: 120%" class="btn btn-success btn-block btn-md btn-responsive">*/ ?>
