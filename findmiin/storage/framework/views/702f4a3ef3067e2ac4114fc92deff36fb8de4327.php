                        ...
                        <div class="col-xs-12 pull-left nopadmar">
                            <div class="row">
                                <div class="square_box col-xs-7 pull-left">
                                    <span><?php echo e(_t('Clients', [], $_SESSION['lang'])); ?></span>
                ...
                <div class="goldbg no-radius">
                    <div class="panel-body squarebox square_boxs" style="padding: 20px 8px;">
                        <div class="col-xs-12 pull-left nopadmar">
                            <div class="row">
                                <div class="square_box col-xs-7 pull-left">
                                    <span><?php echo e(_t('Post', [], $_SESSION['lang'])); ?></span>
            ...
            <div class="col-md-6">
                <div class="panel panel-primary">
                    <div class="panel-heading">
                        <h3 class="panel-title">
                            <i class="livicon" data-name="piechart" data-size="16" data-loop="true" data-c="#000" data-hc="#000"></i>
                            <?php echo e(_t('Post Distributions', [], $_SESSION['lang'])); ?>
...
<?php $__env->startSection('footer_scripts'); ?>
    ...
    <script>
        var user_num = '<?php echo e($user_num); ?>';
        var post_num = '<?php echo e($post_num); ?>';
        var card_num = '<?php echo e($card_num); ?>';
