...
<?php $__env->startSection('title'); ?>
    <?php echo e(_t('Cardfinds', [], $_SESSION['lang'])); ?>
                        ...
                        <tr role="row">
                            <th class="tb_id sorting_asc"  tabindex="0" aria-controls="paidtable" rowspan="1"
                                colspan="1"  aria-label="
                                                   ID
                                            : activate to sort column ascending" style=""><?php echo e(config('Convert.id')[0]); ?>
                            ...
                            <th class="td_width_3 sorting_asc" tabindex="0" aria-controls="paidtable" rowspan="1"
                                colspan="1"  aria-label="
                            ...
                            <th class="sorting_asc" tabindex="0" aria-controls="paidtable" rowspan="1"
                                colspan="1"  aria-label="
                                                   Status
                                            : activate to sort column ascending" style=""><?php echo e(config('Convert.status')[0]); ?>

                            </th>
                            <th class="tb_width_2 sorting" tabindex="0" aria-controls="paidtable" rowspan="1"
                                colspan="1" aria-label="
                                                Created At
                                            : activate to sort column ascending" style=""><?php echo e(config('Convert.create_date')[0]); ?>

                            </th>
                            <th class="tb_width_2 sorting_asc" tabindex="0" aria-controls="paidtable" rowspan="1"
                                colspan="1"  aria-label="
                                                   Actions
                                            : activate to sort column ascending" style=""><?php echo e(config('Convert.actions')[0]); ?>
...
<?php $__env->startSection('footer_scripts'); ?>
    ...
    <script>
        ...
        $(function() {
            ...
            table = $('#advertisetable').DataTable({
                ...
                serverSide: true,
                autoWidth: true,
                ajax: '<?php echo route('admin.cardfinds.data', $type); ?>',
                columns: [
                    { data: 'id', name: 'id' },
            ...
            //$('#advertisetable_filter').append('<button type="button" style="margin-left: 20px; border:1px solid #ccc; background-color: #6c7def; color: white" class="form-control button-sm" onclick="addClient()"><?php echo e(config('Convert.add')[0]); ?></button >');
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content" style="width: 80%">
                ...
                <div class="modal-body">
                    <?php echo e(config('Convert.advertise_delete_message')[0]); ?>

                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" class="form-control" data-dismiss="modal" onclick="deleteData()"><?php echo e(config('Convert.delete')[0]); ?></button>
                    <button type="button" class="btn btn-default" class="form-control" data-dismiss="modal"><?php echo e(config('Convert.cancel')[0]); ?></button>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content" style="width: 80%">
                ...
                <div class="modal-body" id="statecontent">
                    <?php echo e(config('Convert.advertise_active_message')[0]); ?>

                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" class="form-control" data-dismiss="modal" onclick="active_data()"><?php echo e(config('Convert.ok')[0]); ?></button>
                    <button type="button" class="btn btn-default" class="form-control" data-dismiss="modal"><?php echo e(config('Convert.cancel')[0]); ?></button>
                </div>
            </div>
        </div>
    ...
    <div class="modal fade" id="inactiveModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog" role="document">
            <div class="modal-content" style="width: 80%">
                ...
                <div class="modal-body" id="statecontent">
                    <?php echo e(config('Convert.advertise_inactive_message')[0]); ?>

                </div>

                <div class="modal-footer">
                    <button type="button" class="btn btn-default" class="form-control" data-dismiss="modal" onclick="inactive_data()"><?php echo e(config('Convert.ok')[0]); ?></button>
                    <button type="button" class="btn btn-default" class="form-control" data-dismiss="modal"><?php echo e(config('Convert.cancel')[0]); ?></button>
                </div>
            </div>
        </div>
    ...
    <script>
        ...
        function addClient(){
            location.href="<?php echo e(route('admin.cardfinds.add', $type)); ?>";
        }
        function deleteData(){
            var id = $('#deleteid').val();
