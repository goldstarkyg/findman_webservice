<li class="dropdown notifications-menu">
    ...
    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
        ...
        <span id="noticnt" class="label label-warning"><?php echo e($cnt); ?></span>
    </a>
    <ul class=" notifications dropdown-menu">

        <li class="dropdown-title"><?php echo e(_t('You have '.$cnt.' notifications.', [], $_SESSION['lang'])); ?></li>
        <li>
            ...
            <ul class="menu">
                ...
                ?>
                <li id="noti<?php echo e($notification->id); ?>">
                    <div class="row">
                    <div class="col-md-6">
                    ...
                    <div class="row" style="vertical-align: middle;border-bottom: 1px solid #c2cce0;">
                        <i class="livicon success" data-n="hand-right" data-s="15" data-c="white" style="padding: 5px 20px 20px 5px;"
                                                      data-hc="white"></i>
                        <div style="margin-top: 5px;"><?php echo e($notification->content); ?><span class="fa fa-close" style="float: right;margin-right:10px;cursor: pointer" onclick="deleteNotification('<?php echo e($notification->id); ?>')"></span></div>
                    </div>
