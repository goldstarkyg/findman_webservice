                ...
                <!--<form role="form" action="<?php echo e(route('admin.cardfinds.adddata')); ?>" method="POST" enctype="multipart/form-data">-->
                    ...
                    <div class="form-group has-success row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div>
                                <input type="text" class="form-control" id="email" name="email" disabled readonly value="<?php echo e($email_str); ?>" placeholder="email">
                            </div>
                        </div>
                    </div>
                    <div class="form-group has-success row">
                            ...
                            <div style="margin-bottom: 10px">
                                ...
                                <div class="col">
                                    <input value="Jobs" type="checkbox" class="form-control"
                                           <?php echo e(in_array('Jobs', $section_list)? 'checked':''); ?> disabled readonly style="width:16px;height:16px;margin-top:9px;margin-left: 8px;margin-right: 55px;"/>
                                </div>
                            </div>
