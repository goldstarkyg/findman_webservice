...
<section class="content-header">
    <h1><?php echo e(_t('Users', [], $_SESSION['lang'])); ?></h1>
    <ol class="breadcrumb">
        <li>
        ...
        <li class="active"><?php echo e(_t('Users', [], $_SESSION['lang'])); ?></li>
    </ol>
</section>
                ...
                <table class="table table-striped table-bordered table-hover dataTable no-footer sample_editable"
                    ...
                    <tr role="row">
                        ...
                        <th class="sorting" tabindex="0" aria-controls="paidtable" rowspan="1"
                            colspan="1" aria-label="
                                                Email
                                            : activate to sort column ascending" style="width: 100px;"><?php echo e(_t('Email', [], $_SESSION['lang'])); ?>
